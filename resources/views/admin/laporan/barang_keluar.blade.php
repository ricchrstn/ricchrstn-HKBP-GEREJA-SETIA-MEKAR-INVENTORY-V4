                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($barangKeluars as $barangKeluar)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->id }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->barang->nama }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->barang->kategori->nama }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->tanggal->format('d/m/Y') }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->jumlah }} {{ $barangKeluar->barang->satuan }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $barangKeluar->tujuan }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $barangKeluar->user->name }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
