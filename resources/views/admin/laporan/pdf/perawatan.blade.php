...
<body>
    <div class="header">
        <div class="title">LAPORAN PERAWATAN</div>
    ...
    <div class="summary">
        <div class="summary-item">
            <div class="summary-label">Total Perawatan</div>
            <div class="summary-value">{{ $perawatan->count() }}</div>
        </div>
        <div class="summary-item">
            <div class="summary-label">Sedang Diproses</div>
            <div class="summary-value">{{ $perawatan->where('status', 'Diproses')->count() }}</div>
        </div>
        <div class="summary-item">
            <div class="summary-label">Selesai</div>
            <div class="summary-value">{{ $perawatan->where('status', 'Selesai')->count() }}</div>
        </div>
    </div>
