...
@section('title', 'Edit Barang - Pengurus')
                ...
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <div class="flex flex-wrap -mx-3">
                        <div class="flex-none w-full max-w-full px-3 md:w-6/12 md:flex-none">
                            ...
                            <p class="text-sm leading-normal">Edit informasi barang: {{ $barang->nama }}</p>
                        </div>
                        <div class="flex-none w-full max-w-full px-3 md:w-6/12 md:flex-none">
        ...
        <div class="flex-none w-full max-w-full px-3 lg:w-8/12 lg:flex-none">
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-6">
                        <form method="POST" action="{{ route('pengurus.barang.update', $barang) }}" enctype="multipart/form-data">
                            @method('PUT')
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <span class="inline-block px-2 py-1 text-xs font-bold text-white uppercase rounded-lg {{ $barang->status == 'aktif' ? 'bg-gradient-to-tl from-green-600 to-lime-400' : 'bg-gradient-to-tl from-gray-400 to-gray-600' }}">
                    ...
                    <div class="p-6">
                        ...
                        @if($transaksiMasuk)
                            <div class="mb-4">
                                ...
                                <small class="text-slate-400">{{ $transaksiMasuk->created_at->format('d M Y') }}</small>
                            </div>
                        @endif
                        ...
                        @if($transaksiKeluar)
                            <div class="mb-4">
                                ...
                                <small class="text-slate-400">{{ $transaksiKeluar->created_at->format('d M Y') }}</small>
                            </div>
                        @endif
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    if (!preview) {
                        ...
                        preview.className = 'h-20 mt-3 rounded-lg border border-gray-200 shadow-sm object-cover';
